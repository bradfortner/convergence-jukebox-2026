...
def display_45rpm_now_playing_popup(MusicMasterSongList, counter, jukebox_selection_window, upcoming_selections_update):
    ...
    try:
        ...
        # Current: 610x610 pixels - change to desired size (e.g., 800x800, 600x600, etc.)
        popup_width = 610
        popup_height = 610
    ...
    def display_popup_thread():
        ...
        try:
            ...
            # After popup closes, update the upcoming selections display
            ...
            import traceback
            traceback.print_exc()
            # Still call update even if popup fails
            upcoming_selections_update()
