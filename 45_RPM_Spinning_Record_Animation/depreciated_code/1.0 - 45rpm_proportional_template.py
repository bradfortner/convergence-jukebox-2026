...
if __name__ == '__main__':
    image, center_x, center_y = create_vinyl_45_template()

    # Create label width view (only if image was created)
    if image is not None:
        label_diameter_px = int(3.6 * 300)  # 3.6 inches at 300 DPI
        create_label_width_view(image, center_x, center_y, label_diameter_px)
