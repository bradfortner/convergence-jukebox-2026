...
class JukeboxEngine:
    ...
    def __init__(self):
        ...
        self.music_dir = os.path.join(self.dir_path, 'music')
        self.log_file = os.path.join(self.dir_path, 'log.txt')
        self.genre_flags_file = os.path.join(self.dir_path, 'GenreFlagsList.txt')
        self.music_master_song_list_file = os.path.join(self.dir_path, 'MusicMasterSongList.txt')
        self.music_master_song_list_check_file = os.path.join(self.dir_path, 'MusicMasterSongListCheck.txt')
        self.paid_music_playlist_file = os.path.join(self.dir_path, 'PaidMusicPlayList.txt')
        self.current_song_playing_file = os.path.join(self.dir_path, 'CurrentSongPlaying.txt')
    ...
    def generate_mp3_metadata(self):
        ...
        try:
            ...
            try:
                mp3_music_files = glob.glob(os.path.join(self.music_dir, '*.mp3'))
            except Exception as e:
    ...
    def run(self):
        ...
        try:
            ...
            if os.path.exists(self.music_master_song_list_file):
                ...
                try:
                    current_file_count = len(glob.glob(os.path.join(self.music_dir, '*.mp3')))
