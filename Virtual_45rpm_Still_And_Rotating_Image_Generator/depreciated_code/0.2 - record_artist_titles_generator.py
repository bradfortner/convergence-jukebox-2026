"""
================================================================================
RECORD ARTIST TITLES GENERATOR - 1.1
================================================================================
...
OUTPUT:
- record_NNN_ARTIST_SONG.png: Generated record label images
  (numbered sequentially from 000-348, saved to current directory)
...
CHANGES FROM 1.0:
- PNG files now save to current directory instead of record_labels subdirectory
...
for idx, entry in enumerate(artist_song):
    ...
    # Create filename with sequential numbering (000-348) - saved to current directory
    filename = f'record_{idx:03d}_{safe_artist}_{safe_song}.png'
