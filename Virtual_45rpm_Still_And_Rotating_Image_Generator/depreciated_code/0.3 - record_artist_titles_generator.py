"""
================================================================================
RECORD ARTIST TITLES GENERATOR - 1.2
================================================================================
...
artist/song data in a pickle file and creates a single PNG file.
...
OUTPUT:
- record_NNN_ARTIST_SONG.png: Single randomly-selected record label image
...
CHANGES FROM 1.1:
- Now outputs only 1 randomly-selected file instead of batch processing all records
- Removed loop - processes a single random entry from the list
...
# Create filename with record index - saved to current directory
filename = f'record_{selected_idx:03d}_{safe_artist}_{safe_song}.png'
