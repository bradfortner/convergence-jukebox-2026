"""
================================================================================
RECORD ARTIST TITLES GENERATOR - 1.3
================================================================================
...
CHANGES FROM 1.2:
- Output filename is now fixed as final_record_pressing.png
- Removed artist/song name sanitization from filename generation
- Each execution overwrites the previous output file
